...
extension FirebaseViewModel {
    ...
    private func signInGithubHelper() async {
        ...
        do {
            ...
            let customToken = try await getGithubCustomToken(authorizationCode: authorizationCode)
    ...
    func requestGithubAuthorizationCode() async throws -> String {
        guard let clientID = Bundle.main.object(forInfoDictionaryKey: "GITHUB_CLIENT_ID") as? String,
              let redirectURL = Bundle.main.object(forInfoDictionaryKey: "GITHUB_REDIRECT_URL") as? String else {
    ...
    private func getGithubCustomToken(authorizationCode: String) async throws -> String {
        let getTokenFunction = functions.httpsCallable("getGithubCustomToken")
